      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-xl font-bold mb-4">ChefIA PDV</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">(11) 4321-1234</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-gray-400 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">contato@chefiasistemas.com.br</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} ChefIA Sistemas. Todos os direitos reservados.
          </p>
