...
class BusinessDayBase(BaseModel):
    ...
    date: str = Field(..., description="Data do dia de operação no formato ISO (YYYY-MM-DD)")
    notes: Optional[str] = Field(None, description="Observações sobre o dia de operação")
...
def create_business_day(business_day_create: BusinessDayCreate, user_id: str) -> BusinessDay:
