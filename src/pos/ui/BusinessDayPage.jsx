            ...
            <Box sx={{ mt: 3 }}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                  ...
                  <Typography variant="body1">
                    {new Date(businessDayStatus?.opened_at).toLocaleTimeString()}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2" color="text.secondary">
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body1">
                    {businessDayStatus?.opened_at ? 
                      calculateDuration(new Date(businessDayStatus.opened_at), new Date()) : 
                      'N/A'}
                  </Typography>
                </Grid>
              </Grid>
...
// Função auxiliar para calcular a duração entre duas datas
