...
class TestTerminalRouter(unittest.TestCase):
    ...
    def test_get_terminal_configs(self, mock_service_class):
        ...
        # Fazer a requisição
        response = client.get("/api/waiter/terminal/configs?restaurant_id=test-restaurant&store_id=test-store")
        ...
        mock_service.get_terminal_configs.assert_called_once_with("test-restaurant", "test-store")
    ...
    def test_create_terminal_session(self, mock_service_class):
        ...
        # Verificar se o serviço foi chamado corretamente
        mock_service.create_terminal_session.assert_called_once_with("test-terminal-1", "test-waiter-1")
    ...
    def test_get_offline_orders(self, mock_service_class):
        ...
        # Fazer a requisição
        response = client.get("/api/waiter/terminal/offline/orders?terminal_id=test-terminal-1&synced=false")
        ...
        # Verificar se o serviço foi chamado corretamente
        mock_service.get_offline_orders.assert_called_once_with("test-terminal-1", False)
    ...
    def test_sync_terminal_data(self, mock_service_class):
        ...
        # Verificar se o serviço foi chamado corretamente
        mock_service.sync_terminal_data.assert_called_once_with("test-terminal-1", "test-session-1")
