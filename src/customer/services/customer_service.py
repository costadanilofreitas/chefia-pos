...
class CustomerService:
    ...
    async def create_customer(self, customer_create: CustomerCreate) -> Customer:
        ...
        now = datetime.utcnow()
        customer = Customer(
            id=customer_id, created_at=now, last_updated=now, **customer_create.dict()
        )
    ...
    async def update_customer(
        self, customer_id: uuid.UUID, customer_update: CustomerUpdate
    ) -> Optional[Customer]:
    ...
    async def add_address(
        self, customer_id: uuid.UUID, address: Address
    ) -> Optional[Customer]:
    ...
    async def update_address(
        self, customer_id: uuid.UUID, address_id: uuid.UUID, address_update: Address
    ) -> Optional[Customer]:
    ...
    async def update_loyalty_points(
        self, customer_id: uuid.UUID, points_change: int, reason: str = ""
    ) -> Optional[Customer]:
    ...
    async def redeem_points(
        self, customer_id: uuid.UUID, points_to_redeem: int, order_id: uuid.UUID
    ) -> Dict:
        """
    ...
    async def add_purchase_history(
        self, customer_id: uuid.UUID, purchase: PurchaseHistoryEntry
    ) -> Optional[Customer]:
