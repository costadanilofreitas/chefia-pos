...
class Cashier(Base):
    ...
    opening_balance = Column(DECIMAL(10, 2), default=0.0, nullable=False)
    current_balance = Column(DECIMAL(10, 2), default=0.0, nullable=False)
    expected_balance = Column(DECIMAL(10, 2), default=0.0, nullable=False)
    physical_cash_amount = Column(DECIMAL(10, 2), nullable=True)
    cash_difference = Column(DECIMAL(10, 2), nullable=True)
