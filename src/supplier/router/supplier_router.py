...
async def create_supplier(
    supplier_data: SupplierCreate, current_user: User = Depends(get_current_user)
):
...
async def query_suppliers(
    query: SupplierQuery, current_user: User = Depends(get_current_user)
):
...
async def get_supplier_statistics(current_user: User = Depends(get_current_user)):
...
async def create_purchase_order(
    order_data: PurchaseOrderCreate, current_user: User = Depends(get_current_user)
):
...
async def get_purchase_order_statistics(current_user: User = Depends(get_current_user)):
