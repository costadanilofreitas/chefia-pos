...
class DeliveryOptimizationService:
    ...
    async def optimize_delivery_operations(
        ...
        """
        logger.info(f"Optimizing delivery operations for restaurant {restaurant_id} on {date.date()}")
        ...
        try:
            ...
            for time_window in time_windows:
                ...
                recommended_preparation_time = await self._calculate_recommended_preparation_time(
                    expected_demand=expected_demand
                )
    ...
    async def _calculate_recommended_drivers(
        self,
