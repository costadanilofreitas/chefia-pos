...
class InventoryEventPublisher:
    ...
    async def publish_transaction_created(self, transaction_id: uuid.UUID, transaction_data: Dict[str, Any]):
        """Publishes a transaction created event."""
        event = InventoryEvent(
            event_type=InventoryEventType.TRANSACTION_CREATED,
            data={"transaction_id": str(transaction_id), "transaction": transaction_data}
        )
        await self.event_bus.publish(event)
    
    async def publish_transaction_approved(self, transaction_id: uuid.UUID, transaction_data: Dict[str, Any]):
    ...
    async def publish_transaction_rejected(self, transaction_id: uuid.UUID, transaction_data: Dict[str, Any]):
    ...
    async def publish_loss_reported(self, loss_id: uuid.UUID, loss_data: Dict[str, Any]):
    ...
    async def publish_loss_approved(self, loss_id: uuid.UUID, loss_data: Dict[str, Any]):
    ...
    async def publish_loss_rejected(self, loss_id: uuid.UUID, loss_data: Dict[str, Any]):
    ...
    async def publish_count_created(self, count_id: uuid.UUID, count_data: Dict[str, Any]):
    ...
    async def publish_count_submitted(self, count_id: uuid.UUID, count_data: Dict[str, Any]):
    ...
    async def publish_count_approved(self, count_id: uuid.UUID, count_data: Dict[str, Any]):
    ...
    async def publish_count_rejected(self, count_id: uuid.UUID, count_data: Dict[str, Any]):
    ...
    async def publish_low_stock_alert(self, item_id: uuid.UUID, current_stock: float, reorder_point: float):
