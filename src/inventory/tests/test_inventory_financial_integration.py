...
class TestInventoryFinancialIntegration(unittest.TestCase):
    ...
    async def test_loss_financial_posting(self):
        ...
        financial_entry = self.inventory_service._financial_entries_db[
    ...
    async def test_purchase_financial_posting(self):
        ...
        transaction = await self.inventory_service.create_transaction(
            transaction_create
        )
        ...
        financial_entries = [
            entry
            for entry in self.inventory_service._financial_entries_db.values()
        ...
        self.assertEqual(
            financial_entry.entry_type, FinancialEntryType.INVENTORY_PURCHASE
        )
    ...
    async def test_adjustment_financial_posting(self):
        ...
        self.assertEqual(
            financial_entry.entry_type, FinancialEntryType.INVENTORY_ADJUSTMENT
        )
...
def run_tests():
    ...
    suite.addTest(
        TestInventoryFinancialIntegration("test_adjustment_financial_posting")
    )
    suite.addTest(
        TestInventoryFinancialIntegration("test_financial_entry_creation_failure")
    )
