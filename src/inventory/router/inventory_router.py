...
@router.post(
    "/items", response_model=InventoryItem, status_code=status.HTTP_201_CREATED
)
...
@router.post(
    "/transactions/{transaction_id}/approve", response_model=InventoryTransaction
)
...
@router.post(
    "/transactions/{transaction_id}/reject", response_model=InventoryTransaction
)
...
@router.post(
    "/losses", response_model=InventoryLoss, status_code=status.HTTP_201_CREATED
)
...
@router.post(
    "/counts", response_model=InventoryCount, status_code=status.HTTP_201_CREATED
)
