...
class InvoicePrintService:
    ...
    async def print_invoice(
        ...
        try:
            ...
            if not printer_id:
                logger.error(
                    "Nenhuma impressora térmica disponível para impressão da nota fiscal"
                )
                return False
    ...
    def _prepare_template_data(
        ...
        template_data = {
            ...
            "is_homologation": (
                sat_data.get("is_homologation", True) if sat_data else True
            ),
