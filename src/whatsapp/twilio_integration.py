...
class TwilioWhatsAppIntegration:
    ...
    def send_template_message(self, to: str, template_name: str, 
        ...
        try:
            ...
            logger.info(f"Template message sent successfully to {to}, SID: {message.sid}")
            return {
                'success': True,
                'message_sid': message.sid,
                'status': message.status
    ...
    def send_interactive_message(self, to: str, body: str, 
        ...
        try:
            ...
            logger.info(f"Interactive message sent successfully to {to}, SID: {message.sid}")
            return {
                'success': True,
                'message_sid': message.sid,
                'status': message.status
    ...
    def send_list_message(self, to: str, body: str, button_text: str,
