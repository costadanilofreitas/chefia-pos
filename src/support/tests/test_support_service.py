...
class TestTicketService(unittest.TestCase):
    ...
    def test_create_ticket(self):
        ...
        # Executar teste
        ticket = self.loop.run_until_complete(self.ticket_service.create_ticket(ticket_data))
    ...
    def test_get_ticket(self):
        ...
        # Executar teste
        retrieved_ticket = self.loop.run_until_complete(self.ticket_service.get_ticket(ticket["id"]))
    ...
    def test_update_ticket(self):
        ...
        # Executar teste
        updated_ticket = self.loop.run_until_complete(self.ticket_service.update_ticket(ticket["id"], update_data))
    ...
    def test_add_message(self):
        ...
        # Executar teste
        message = self.loop.run_until_complete(self.ticket_service.add_message(ticket["id"], message_data))
        ...
        updated_ticket = self.loop.run_until_complete(self.ticket_service.get_ticket(ticket["id"]))
        
        # Verificar que a mensagem foi adicionada ao ticket
        self.assertEqual(len(updated_ticket["messages"]), 2)  # Descrição inicial + nova mensagem
        
        # Verificar evento publicado
        self.assertEqual(self.event_bus.published_events[2]["type"], "ticket.message.created")
    ...
    def test_get_tickets(self):
        ...
        all_tickets = self.loop.run_until_complete(self.ticket_service.get_tickets("restaurant-123"))
        ...
        self.assertEqual(high_priority_tickets["items"][0]["subject"], "Problema com impressora")
        ...
        self.assertEqual(software_tickets["items"][0]["subject"], "Dúvida sobre relatório")
...
class TestChatbotService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.event_bus = MockEventBus()
        self.chatbot_service = ChatbotService(self.db_service, self.config_service, self.event_bus)
    ...
    def test_start_chat(self):
        ...
        # Verificar evento publicado
        self.assertEqual(len(self.event_bus.published_events), 2)  # start + welcome message
    ...
    def test_add_message(self):
        ...
        # Executar teste
        message = self.loop.run_until_complete(self.chatbot_service.add_message(chat["id"], message_data))
        ...
        updated_chat = self.loop.run_until_complete(self.chatbot_service.get_chat(chat["id"]))
        
        # Verificar que a mensagem foi adicionada à conversa
        self.assertGreater(len(updated_chat["messages"]), 1)  # Boas-vindas + nova mensagem
        
        # Verificar evento publicado
        self.assertEqual(self.event_bus.published_events[0]["type"], "chat.message.created")
    ...
    def test_end_chat(self):
        ...
        # Executar teste
        closed_chat = self.loop.run_until_complete(self.chatbot_service.end_chat(chat["id"], "user_requested"))
        ...
        self.assertEqual(self.event_bus.published_events[1]["type"], "chat.message.created")  # Mensagem de encerramento
    ...
    def test_transfer_to_human(self):
        ...
        # Executar teste
        transferred_chat = self.loop.run_until_complete(self.chatbot_service.transfer_to_human(chat["id"], "agent-456"))
        ...
        self.assertEqual(self.event_bus.published_events[1]["type"], "chat.message.created")  # Mensagem de transferência
        self.assertEqual(self.event_bus.published_events[2]["type"], "ticket.created")  # Criação do ticket
...
class TestKnowledgeBaseService(unittest.TestCase):
    ...
    def test_create_article(self):
        ...
        # Executar teste
        article = self.loop.run_until_complete(self.knowledge_service.create_article(article_data))
    ...
    def test_get_article(self):
        ...
        # Executar teste
        retrieved_article = self.loop.run_until_complete(self.knowledge_service.get_article(article["id"]))
        
        # Verificar resultados
        self.assertEqual(retrieved_article["id"], article["id"])
        self.assertEqual(retrieved_article["title"], article["title"])
        self.assertEqual(retrieved_article["view_count"], 1)  # Incrementado após visualização
    ...
    def test_update_article(self):
        ...
        # Executar teste
        updated_article = self.loop.run_until_complete(self.knowledge_service.update_article(article["id"], update_data))
    ...
    def test_delete_article(self):
        ...
        # Executar teste
        result = self.loop.run_until_complete(self.knowledge_service.delete_article(article["id"]))
        ...
        try:
            self.loop.run_until_complete(self.knowledge_service.get_article(article["id"]))
    ...
    def test_get_articles(self):
        ...
        self.loop.run_until_complete(self.knowledge_service.create_article(article_data1))
        self.loop.run_until_complete(self.knowledge_service.create_article(article_data2))
        
        # Executar teste - todos os artigos
        all_articles = self.loop.run_until_complete(self.knowledge_service.get_articles("restaurant-123"))
        ...
        self.assertEqual(hardware_articles["items"][0]["title"], "Como configurar uma impressora")
    ...
    def test_rate_article(self):
        ...
        rated_article = self.loop.run_until_complete(self.knowledge_service.rate_article(article["id"], True))
        ...
        rated_article = self.loop.run_until_complete(self.knowledge_service.rate_article(article["id"], False))
...
class TestSupportAnalyticsService(unittest.TestCase):
    ...
    def _create_test_data(self):
        ...
        self.loop.run_until_complete(self.db_service.insert("knowledge_articles", article1))
        self.loop.run_until_complete(self.db_service.insert("knowledge_articles", article2))
    
    def test_get_support_metrics(self):
        """Testa a obtenção de métricas de suporte."""
        # Executar teste
        metrics = self.loop.run_until_complete(self.analytics_service.get_support_metrics("restaurant-123"))
        ...
        self.assertEqual(metrics["chats"]["escalation_rate"], 1/3)  # 1 transferido de 3 total
        ...
        self.assertEqual(metrics["knowledge_base"]["helpfulness_rate"], 45/53)  # (30+15)/(30+15+5+3)
...
class TestTwilioService(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        result = self.loop.run_until_complete(
            self.twilio_service.send_message("+5511999999999", "Olá, como posso ajudar?")
        )
    ...
    def test_receive_message(self):
        ...
        # Executar teste
        result = self.loop.run_until_complete(self.twilio_service.receive_message(message_data))
...
class TestBedrockService(unittest.TestCase):
    ...
    def test_generate_response(self):
        ...
        response1 = self.loop.run_until_complete(self.bedrock_service.generate_response(prompt1))
        ...
        response2 = self.loop.run_until_complete(self.bedrock_service.generate_response(prompt2))
        ...
        response3 = self.loop.run_until_complete(self.bedrock_service.generate_response(prompt3))
...
class TestSupportService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_service = MockConfigService()
        self.event_bus = MockEventBus()
        self.support_service = SupportService(self.db_service, self.config_service, self.event_bus)
    ...
    def _create_test_data(self):
        ...
        self.loop.run_until_complete(self.db_service.insert("knowledge_articles", article))
    ...
    def test_search_support_resources(self):
        ...
        results = self.loop.run_until_complete(
            self.support_service.search_support_resources("restaurant-123", "impressora")
        )
