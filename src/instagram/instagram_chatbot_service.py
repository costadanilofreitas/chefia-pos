...
class InstagramChatbotService(BaseChatbotService):
                ...
                responses.append(
                    {
                        ...
                        "options": [
                            {
                                "id": f"view_item_{items[0]['id']}",
                                "title": f"1. {items[0]['name']}",
                            },
                            {
                                "id": f"view_item_{items[1]['id']}",
                                "title": f"2. {items[1]['name']}",
                            },
                            {
                                "id": f"view_item_{items[2]['id']}",
                                "title": f"3. {items[2]['name']}",
                            },
                        ],
                    }
                )
    ...
    async def _handle_checkout(
        ...
        return {"type": MessageType.TEXT, "text": "Continuando com seu pedido..."}
