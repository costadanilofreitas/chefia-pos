...
class EventLogger:
    ...
    def __init__(self, event_bus=None, database=None, log_to_console=False, log_to_file=False, log_file_path=None):
    ...
    async def get_events_by_criteria(self, criteria: Dict[str, Any], limit: int = 100, skip: int = 0) -> List[Dict[str, Any]]:
        """
