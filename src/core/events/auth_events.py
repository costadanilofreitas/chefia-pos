...
async def publish_user_permission_changed(user: User, old_permissions: list, new_permissions: list) -> None:
...
async def publish_system_error(message: str, code: str = None, details: Dict[str, Any] = None) -> None:
...
async def publish_system_config_changed(config: Dict[str, Any], changed_by: str = None) -> None:
