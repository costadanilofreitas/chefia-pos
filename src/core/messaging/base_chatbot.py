...
class BaseEventIntegration(ABC):
    ...
    @abstractmethod
    async def receive_messages(self, max_messages: int = 10, wait_time_seconds: int = 20) -> List[Dict[str, Any]]:
        """
...
class BaseChatbotService(ABC):
    ...
    async def update_conversation_state(self, user_id: str, state: str) -> Dict[str, Any]:
        """
    ...
    async def add_message_to_conversation(self, user_id: str, message: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def update_conversation_context(self, user_id: str, context_updates: Dict[str, Any]) -> Dict[str, Any]:
        """
...
class BaseIntegratedChatbot(ABC):
    ...
    @abstractmethod
    async def send_marketing_campaign(self, customer_data: Dict[str, Any], campaign_type: str, 
