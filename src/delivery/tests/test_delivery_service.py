...
class TestDeliveryService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Criar zona de teste
        self.test_zone = asyncio.run(zone_service.create_zone(
            name="Zona Teste",
            base_fee=5.0,
        ...
        self.test_courier = asyncio.run(courier_service.create_courier(
    ...
    def test_create_delivery_order(self):
        ...
        # Criar pedido
        delivery_order = asyncio.run(delivery_service.create_delivery_order(
            order_id="order123",
    ...
    def test_assign_courier(self):
        ...
        # Atribuir entregador
        updated_order = asyncio.run(delivery_service.assign_courier(
            delivery_order_id=delivery_order.id,
            courier_id=self.test_courier.id
        ))
    ...
    def test_update_order_status(self):
        ...
        # Atualizar status
        updated_order = asyncio.run(delivery_service.update_order_status(
            delivery_order_id=delivery_order.id,
    ...
    def test_calculate_delivery_fee(self):
        ...
        # Calcular taxa
        fee = asyncio.run(delivery_service.calculate_delivery_fee(
            address_id="address789",
            order_value=50.0
        ))
        ...
        asyncio.run(zone_service.update_zone(
            zone_id=self.test_zone.id,
            data={"min_order_value": 30.0}
        ))
    ...
    def test_estimate_delivery_time(self):
        ...
        # Estimar tempo
        time = asyncio.run(delivery_service.estimate_delivery_time(
            address_id="address789"
        ))
    ...
    def test_get_tracking_history(self):
        ...
        # Atualizar status
        asyncio.run(delivery_service.update_order_status(
            delivery_order_id=delivery_order.id,
            status=DeliveryOrderStatus.PREPARING,
            notes="Pedido em preparação"
        ))
        ...
        # Obter histórico
        history = asyncio.run(delivery_service.get_tracking_history(
            delivery_order_id=delivery_order.id
        ))
...
class TestCourierService(unittest.TestCase):
    ...
    def test_create_courier(self):
        ...
        # Criar entregador
        courier = asyncio.run(courier_service.create_courier(
            name="Entregador Teste",
            phone="11999999999",
            vehicle_type="moto",
            courier_type=CourierType.EMPLOYEE
    ...
    def test_update_courier_status(self):
        ...
        # Atualizar status
        updated_courier = asyncio.run(courier_service.update_courier_status(
        ...
        updated_courier = asyncio.run(courier_service.update_courier_after_delivery(
            courier_id=courier.id
        ))
    ...
    def test_update_courier_location(self):
        ...
        updated_courier = asyncio.run(courier_service.update_courier_location(
            courier_id=courier.id,
            location=location
        ))
    ...
    def test_list_couriers(self):
        ...
        # Criar entregadores
        courier1 = asyncio.run(courier_service.create_courier(
            name="Entregador 1",
            phone="11999999991",
            vehicle_type="moto",
            courier_type=CourierType.EMPLOYEE
        ...
        courier2 = asyncio.run(courier_service.create_courier(
            name="Entregador 2",
            phone="11999999992",
            vehicle_type="carro",
        ...
        asyncio.run(courier_service.update_courier_status(
        ...
        available_couriers = asyncio.run(courier_service.list_couriers(
        ...
        freelance_couriers = asyncio.run(courier_service.list_couriers(
            courier_type=CourierType.FREELANCER
        ))
...
class TestZoneService(unittest.TestCase):
    ...
    def test_create_zone(self):
        ...
        # Criar zona
        zone = asyncio.run(zone_service.create_zone(
            name="Zona Teste",
            base_fee=5.0,
            min_delivery_time=20,
            max_delivery_time=40,
    ...
    def test_update_zone(self):
        ...
        # Atualizar zona
        updated_zone = asyncio.run(zone_service.update_zone(
            zone_id=zone.id,
            data={
    ...
    def test_list_zones(self):
        ...
        # Criar zonas
        zone1 = asyncio.run(zone_service.create_zone(
            name="Zona 1",
            base_fee=5.0,
            min_delivery_time=20,
            max_delivery_time=40,
        ...
        zone2 = asyncio.run(zone_service.create_zone(
            name="Zona 2",
            base_fee=7.0,
    ...
    def test_check_address_deliverable(self):
        ...
        is_deliverable = asyncio.run(zone_service.check_address_deliverable("address123"))
