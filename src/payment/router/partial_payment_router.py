...
async def get_payment_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao obter sessão de pagamento: {str(e)}")
...
async def get_sessions_by_order(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao obter sessões de pagamento: {str(e)}")
...
async def update_payment_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao atualizar sessão de pagamento: {str(e)}")
...
async def close_payment_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao fechar sessão de pagamento: {str(e)}")
...
async def cancel_payment_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao cancelar sessão de pagamento: {str(e)}")
...
async def create_partial_payment(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao criar pagamento parcial: {str(e)}")
...
async def get_payments_by_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao obter pagamentos: {str(e)}")
...
async def create_bill_split(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao criar divisão de conta: {str(e)}")
...
async def get_bill_split(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao obter divisão de conta: {str(e)}")
...
async def create_equal_split(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao criar divisão igualitária: {str(e)}")
...
async def create_custom_split(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao criar divisão personalizada: {str(e)}")
...
async def pay_split_part(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao pagar parte da divisão: {str(e)}")
