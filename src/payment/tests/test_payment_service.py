...
class TestPaymentService(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.event_bus_patch = patch(
            "src.payment.services.payment_service.get_event_bus",
        ...
        self.payment_service.adapters = {PaymentProvider.ASAAS: self.asaas_adapter_mock}

        # Mock para métodos internos
        self.payment_service._get_provider_config = MagicMock(
    ...
    async def test_update_payment_status(self):
        ...
        updated_payment = await self.payment_service.update_payment_status(
            "payment_id_123", PaymentStatus.CONFIRMED, datetime.now()
        )
    ...
    async def test_process_webhook(self):
        ...
        self.payment_service.get_payment_by_provider_id = AsyncMock(
        ...
        self.payment_service.get_payment_by_provider_id.assert_called_once_with(
    ...
    async def test_check_payment_status(self):
        ...
        self.payment_service.update_payment_status = AsyncMock(
