...
class TestAsaasAdapter(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.session_patch = patch(
            "aiohttp.ClientSession", return_value=self.session_mock
        )
    ...
    async def test_create_payment(self):
        ...
        self.response_mock.json.side_effect = [
            ...
            {"id": "payment_123", "status": "PENDING", "dueDate": "2025-05-25"},
            # Resposta para obtenção de QR Code PIX
            {"payload": "pix_key_123", "encodedImage": "qrcode_data"},
        ]
    ...
    async def test_process_webhook_invalid_event(self):
        ...
        # Dados do webhook
        webhook_data = {"event": "INVALID_EVENT", "payment": {"id": "payment_123"}}
