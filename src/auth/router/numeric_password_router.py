...
from ..models.numeric_password_models import (
    ...
    OperatorCredentialCreate, OperatorCredentialUpdate, OperatorCredentialReset,
    AuthConfig
)
...
async def create_credential(
    ...
    try:
        ...
        return {"message": "Credencial criada com sucesso", "operator_id": credential.operator_id}
    except ValueError as e:
        raise HTTPException(
...
async def update_password(
    ...
    try:
        ...
        return {"message": "Senha atualizada com sucesso", "operator_id": credential.operator_id}
    except ValueError as e:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail=str(e)
