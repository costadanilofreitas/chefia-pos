...
class TestRappiRouter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.service_patch = patch(
            "src.remote_orders.router.rappi_router.get_rappi_order_service",
    ...
    def test_rappi_webhook_no_order(self):
        ...
        webhook_data = {
            ...
            "restaurant_id": "test_restaurant_id",
            "order": {"id": "rappi_order_123", "status": "DELIVERED"},
        }
        ...
        self.assertEqual(
            response.json(),
            {"status": "ignored", "message": "Webhook ignored or no action required"},
        )
    ...
    def test_confirm_rappi_order(self):
        ...
        # Fazer requisição ao endpoint
        response = self.client.post(
            "/api/remote-orders/rappi/orders/rappi_order_123/confirm"
        )
        ...
        # Verificar se o serviço foi chamado corretamente
        self.mock_service.confirm_remote_order.assert_called_once_with(
            "rappi_order_123"
        )
    ...
    def test_reject_rappi_order(self):
        ...
        self.assertEqual(
            response.json(),
            {"status": "success", "message": "Order rejected successfully"},
        )

        # Verificar se o serviço foi chamado corretamente
        self.mock_service.reject_remote_order.assert_called_once_with(
    ...
    def test_update_rappi_order_status(self):
        ...
        self.assertEqual(
            response.json(),
            {"status": "success", "message": "Order status updated to PREPARING"},
        )
    ...
    def test_update_product_availability(self):
        ...
        self.assertEqual(
            ...
            {
                "status": "success",
                "message": "Product product_123 availability updated to True",
            },
        )

        # Verificar se o serviço foi chamado corretamente
        self.mock_service.update_product_availability.assert_called_once_with(
            "test_restaurant_id", "product_123", True
        )
