...
class RemoteOrderEventPublisher:
    ...
    async def publish_order_received(
        self, order_id: str, platform: RemotePlatform, external_id: str
    ) -> None:
    ...
    async def publish_order_accepted(
        self, order_id: str, internal_order_id: str
    ) -> None:
    ...
    async def publish_status_changed(
        self,
        order_id: str,
        old_status: RemoteOrderStatus,
        new_status: RemoteOrderStatus,
    ) -> None:
    ...
    async def publish_error(
        self, platform: RemotePlatform, error: str, details: Dict[str, Any] = None
    ) -> None:
