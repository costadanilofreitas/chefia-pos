...
class IFoodWebhookHandler:
    ...
    async def process_webhook(self, 
        ...
        try:
            ...
            if x_ifood_signature and self.webhook_secret:
                is_valid = await self.api_client.verify_webhook_signature(x_ifood_signature, payload)
                if not is_valid:
            ...
            if background_tasks:
                ...
                return {"success": True, "message": "Webhook recebido e será processado em background"}
            else:
    ...
    async def _handle_order_placed(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.order_confirmation_handler:
                confirmation_result = await self.order_confirmation_handler(complete_order_data)
    ...
    async def _handle_status_changed(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            internal_status = self.status_mapping.get(new_status, RemoteOrderStatus.PENDING)
    ...
    async def _handle_integration_event(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not event_code:
                logger.error("Código do evento não encontrado no evento INTEGRATION_EVENT")
