...
class IFoodAuthManager:
    ...
    def __init__(
        self, client_id: str = None, client_secret: str = None, merchant_id: str = None
    ):
        """
        ...
        if not self.client_id or not self.client_secret:
            logger.warning(
                "Credenciais do iFood não configuradas. A integração não funcionará corretamente."
            )
    ...
    async def authenticate(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Autenticação com iFood bem-sucedida, token válido até {self.token_expiry}"
            )
            return {
                "success": True,
    ...
    async def refresh_access_token(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = requests.post(self.auth_url, data=refresh_data, headers=headers)
            ...
            logger.info(
                f"Token do iFood renovado com sucesso, válido até {self.token_expiry}"
            )
            return {
                "success": True,
                "access_token": self.access_token,
