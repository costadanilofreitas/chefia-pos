...
class TestSATModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.makedirs(os.path.join(os.path.dirname(__file__), '../../pos/config'), exist_ok=True)
        ...
        terminal_config_path = os.path.join(os.path.dirname(__file__), '../../pos/config/1.json')
    ...
    def test_sat_disabled(self):
        ...
        order_data = {
            "id": "TEST-ORDER-002",
            "total": 100.0,
            "items": [{"product_id": "P001", "name": "Produto Teste", "quantity": 1, "price": 100.0, "total": 100.0}],
